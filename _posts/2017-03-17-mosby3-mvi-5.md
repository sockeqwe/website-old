...
Have you ever get a crash report and you were not able to reproduce the bug? Sounds familiar?
For me it definitely does. After having spend many hours looking at the stacktrace and our source code many times I gave up and have closed such issues in our issue tracker with a little comment like "can't reproduce it" or "must be a strange device / manufacturer specific bug".
