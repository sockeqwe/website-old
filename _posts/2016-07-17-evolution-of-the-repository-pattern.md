...
Second Question: **What are the benefits of abstractions like `Specification`?**
 ...
 - Open / Closed principle: As pointed out by Krzychu Kosobudzki correctly, this allows to create new specifications (and therefore new query functionality) without having to touch something else in your code base.
