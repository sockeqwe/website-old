...
This method is invoked only the first time a View is attached to the Presenter.It's not invoked again when the View gets reattached (i.e. after a screen orientation change).
