...
tags: [android, java]
---
In the [fist part](http://hannesdorfmann.com/android/mosby3-mvi-1) what a model actually should be,
how we should model our Models and how it solves some common issues in android development.
In this blog post we continue by introducing the **M**odel-**V**iew-**I**ntent pattern to build Reactive Apps.

If you haven't read [part 1](http://hannesdorfmann.com/android/mosby3-mvi-1) yet, you should read that first before continue with the second part. To summarize:
