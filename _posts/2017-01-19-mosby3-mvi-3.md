...
Implementing pagination (loading next "page" of items) is pretty the same as pull-to-refresh except that we are adding the loaded at the end of the list instead of the top of the list as we do with pull-to-refresh.
