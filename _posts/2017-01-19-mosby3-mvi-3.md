...
{% endhighlight %}
The concrete View implementation is pretty straight forward and therefore I won't show the code here (can be found [here](https://github.com/sockeqwe/mosby/blob/master/sample-mvi/src/main/java/com/hannesdorfmann/mosby3/sample/mvi/view/home/HomeFragment.java)). Next, let's focus on the model. As already said in previous posts the Model should reflect all those possible states. So let's introduce a Model called **HomeViewState**:
