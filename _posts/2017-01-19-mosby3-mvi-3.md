...
<center><b><i>Ladies and Gentleman, please give a warm welcome to the STATE REDUCER</i></b></center>
...
We have to introduce another class representing the partial change (the thing we have called Foo in the code snipped above) in the previous code snipped) that will be used to compute the new state.
