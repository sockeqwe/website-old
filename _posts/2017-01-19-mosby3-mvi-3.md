      ...
      Observable<PartialState> loadMoreFromCategory =
          intent(HomeView::loadAllProductsFromCategoryIntent)
              .flatMap(categoryName -> feedLoader.loadProductsOfCategory(categoryName)
                  .map( products -> new PartialState.ProductsOfCategoriesLoaded(categoryName, products))
                  .startWith(new PartialState.ProductsOfCategoriesLoading(categoryName))
                  .onErrorReturn(error -> new PartialStateChanges.PartialState(categoryName, error)));
