...
If you want to learn more about `FragmentArgs` check out the FragmentArgs project on [github](https://github.com/sockeqwe/fragmentargs) where you will get more information about the API and how to use it. FragmentArgs is available at maven central.
